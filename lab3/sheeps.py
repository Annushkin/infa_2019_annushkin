...
def sheeps (x1, y1, r1):
    ...
    polygon([(x1 - r1 * 1.5, y1 + 3 / 4 * r1), (x1 - r1 * 1.5 - 10,
            y1 + 3 / 4  *r1 - 5), (x1 - r1 * 1.5 - 10, y1 + 3 / 4 * r1 + 5),
            (x1 - r1 * 1.5, y1 + 3 / 4 * r1)])
    polygon([(x1 - r1 * 1.5 + 3, y1 + 3 / 4 * r1 - 5), (x1 - r1 * 1.5 - 5,
            y1 + 3 / 4 * r1 - 15), (x1 - r1 * 1.5 - 10, y1 + 3 / 4 * r1 - 5),
            (x1 - r1 * 1.5 + 3, y1 + 3 / 4 * r1 - 5)])
